...
class NetModel:
    ...
    def __init__(self, args):
        ...
        load_S_model(args, student, False)  # todo: 在基础模型基础上蒸馏?
        ...
        # HOlistic, 整体蒸馏
        self.criterion_adv = self.DataParallelCriterionProcess(CriterionAdv(args.adv_loss_type))  # wgan-gp
    ...
    def forward(self):
        ...
        # teacher 转到 eval 状态, 得到 teacher 输出
        with torch.no_grad():
    ...
    def optimize_parameters(self):
        ...
        # student_backward() 包括了 model infer 过程
        self.student_backward()  # todo: 核心训练 code
        self.G_solver.step()

        # todo: 是否采用 discriminator
        if self.args.ho == True:
